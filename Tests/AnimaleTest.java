...
public class AnimaleTest {
    ...
    public void TestRiproduci(){
        Animale animal1 = new Animale(SpecieAnimalie.DODO,10, 0,3,"cipolla");
        Animale animal2 = new Animale(SpecieAnimalie.DODO,10, 0,2,"sale");
        assertEquals(1,animal1.riproduci(List.of(animal2, animal1), 0));
        assertEquals(0,animal1.riproduci(List.of(animal2, animal1), 1));
        Animale animal3 = new Animale(SpecieAnimalie.DODO,10, 0,3,"cipolla");
        Animale animal4 = new Animale(SpecieAnimalie.DODO,10, 0,2,"sale");
        assertEquals(2,animal3.riproduci(List.of(animal3, animal4), 1));
        Animale animal5 = new Animale(SpecieAnimalie.DODO,10, 0,3,"cipolla");
        Animale animal6 = new Animale(SpecieAnimalie.DODO,10, 0,2,"sale");
